...
public class Rcard3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rcard3);
        ...
        changeimage1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                IMG_1.setImageDrawable(getDrawable(R.drawable.dallake));
            }
        });
        changeimage2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IMG_1.setImageDrawable(getDrawable(R.drawable.dallake2));
            }
        });
        changeimage3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                IMG_1.setImageDrawable(getDrawable(R.drawable.dallake3));
            }
        });
